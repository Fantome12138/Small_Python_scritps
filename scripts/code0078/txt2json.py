...
def txt2json(_type):
    ...
    write_json_context['info']= {'description': 'For Large Vision Models', 'url': '',
                                 'version': VSERSION, 'year': YEAR, 'contributor': CONTRIBUTOR,
                                 'date_created': DATA_CREATED}
    write_json_context['licenses']=[{'id':'','name':'','url':None}]
    ...
    for i,imageFile in enumerate(imageFileList):
        ...
        img_context['width']=W
        img_context['date_captured']=DATA_CAPTURED
    ...
    name = os.path.join(coco_format_save_path,'instances_'+str(_type)+ '.json')
...
VSERSION = 'v0.3'
YEAR = 2024
DATA_CREATED = '2024-01-17'
CONTRIBUTOR = 'wyang'
DATA_CAPTURED = DATA_CREATED
_type = 'train'
coco_format_save_path=f'/home/LVM_DATA/new_untrain/'   #要生成的标准coco格式标签所在文件夹
yolo_format_classes_path=f'/home/LVM_DATA/new_untrain/class.txt'     #类别文件，一行一个类
yolo_format_annotation_path=f'/home/LVM_DATA/new_untrain/{_type}_labels/'  #yolo格式标签所在文件夹
img_pathDir=f'/home/LVM_DATA/new_untrain/{_type}_images/'    #图片所在文件夹
txt2json(_type)
